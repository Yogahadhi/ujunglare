<div class="card card-primary">
	...
	<form action="" method="post" enctype="multipart/form-data">
		...
		<div class="card-footer">
			...
			<a href="?page=data-laki" title="Kembali" class="btn btn-secondary">Batal</a>
		</div>
	</form>
</div>
...
if (isset($_POST['Simpan'])) {
	...
	$sql_simpan = "INSERT INTO tb_pdd (nik, nama, tempat_lh, tgl_lh, jekel, desa, rt, rw, agama, kawin, pekerjaan, status, stunting) VALUES (
            '" . $_POST['nik'] . "',
            '" . $_POST['nama'] . "',
			'" . $_POST['tempat_lh'] . "',
			'" . $_POST['tgl_lh'] . "',
	...
	if ($query_simpan) {
      ...
      Swal.fire({title: 'Tambah Data Berhasil',text: '',icon: 'success',confirmButtonText: 'OK'
          ...
          window.location = 'index.php?page=data-laki';
          }
      })</script>";
	} else {
		echo "<script>
      Swal.fire({title: 'Tambah Data Gagal',text: '',icon: 'error',confirmButtonText: 'OK'
          ...
          window.location = 'index.php?page=add-laki';
          }
      })</script>";
	}
}
